...
- The app is built on Electron and Svelte, which ensures modularity of the user interface and clear separation of logic between individual components.

![Preview2](imgs/preview2.png)

- The application contains several themes, which increases the customization of the interface.
...
After launching, you need to select the necessary section from the app menu and work with the interface
Interface appearance after launching the app:
...
| [Additionally](additionally.md)             | Additional app modules                                                          |

## App structure

The app is based on Electron in a combination of Svelte + NodeJS + Python/C#:

- After starting the app, a Python server is started in command waiting mode, the process of which is attached to the Electron process.
...
![App Structure](../imgs/schema1.png)
