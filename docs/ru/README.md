...
| EN [English](../README.md) | RU [Український](../uk/README.md) | RU [Русский](README.md) |
|---|---|---|

Работайте с документами, экономя до 95% времени с программным обеспечением для профессиональных колледжей!

![Превью](https://github.com/IKorzI/Sonata/blob/main/docs/ru/imgs/preview.png)
...
* создание пустых сводных сведений; 
...
После запуска необходимо выбрать необходимый раздел из меню программы и работать с интерфейсом
...
|[пустые сведения](empty_statements.md) | Создание пустых сводных сведений
...
|[Дополнительно](additionally.md) | Дополнительные модули программы
...
* После нажатия кнопки "Старт" конечные данные от пользователя переходят через финальное дополнение и расчеты в NodeJS перед отправкой в ​​Python 
