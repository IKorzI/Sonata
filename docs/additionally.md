...
![Example of a question mark in the block for loading a file into the program](https://github.com/IKorzI/Sonata/blob/main/docs/uk/imgs/select_file.png) ![Example of a question mark in the block for saving a file to the device](https://github.com/IKorzI/Sonata/blob/main/docs/uk/imgs/save_file.png) ![Example of a question mark in the block for generating a numerator/denominator graph file](https://github.com/IKorzI/Sonata/blob/main/docs/uk/imgs/num_den.png)
...
![Example of window1 that opens](https://github.com/IKorzI/Sonata/blob/main/docs/uk/imgs/select_file_example_window.png)
![Example of window2 that opens](https://github.com/IKorzI/Sonata/blob/main/docs/uk/imgs/example_of_output_document(s)_example_window.png)
...
![Change the program language](https://github.com/IKorzI/Sonata/blob/main/docs/uk/imgs/language.png)
...
![Light theme](https://github.com/IKorzI/Sonata/blob/main/docs/uk/imgs/light_theme.png)
...
![Light theme](https://github.com/IKorzI/Sonata/blob/main/docs/uk/imgs/error_window.png)
